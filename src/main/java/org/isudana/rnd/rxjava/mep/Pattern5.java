...
public class Pattern5 {
    ...
    private static final Logger log = LoggerFactory.getLogger(Pattern5.class);

    public static void main(String[] args) {

        org.apache.log4j.BasicConfigurator.configure();

        int mainThreadProcessingTime = 1000;        // indication of time takes to do some processing at main thread
        ...
        // Step 2 - Delegate a task to a new workers
        ...
        // (whichever comes first) and proceed - result is not available at this moment as
