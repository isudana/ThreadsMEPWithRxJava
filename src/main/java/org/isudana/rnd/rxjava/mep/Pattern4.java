...
public class Pattern4 {
    ...
    private static final Logger log = LoggerFactory.getLogger(Pattern4.class);
    ...
    public static void main(String[] args) {
        ...
        // Step 4 - Subscribe to responses of spawned worker thread - When we subscribe, result is already available
